...
<section className="section">
  <div className="wrap">
    <div className="section-head" data-reveal>
      ...
      <h2>Growing Businesses Get Stuck In The Same Traps</h2>
...
<section className="section section-alt">
  <div className="wrap">
    <div className="section-head" data-reveal>
      ...
      <h2>Practical Digital Solutions for Growing Teams</h2>
    ...
    <div className="h-accordion">
      <div className="h-panel p1" data-reveal>
        <div className="h-panel-bg"></div>
        <div className="h-panel-content">
          <div className="h-panel-top">
            <span className="h-num">01</span>
            <div className="h-icon"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></div>
          </div>
          <div className="h-title-vertical">Workflow Automation</div>
          <div className="h-panel-bottom">
            <h3 className="h-title-horizontal">Workflow Automation</h3>
      ...
      <div className="h-panel p2" data-reveal>
        <div className="h-panel-bg"></div>
        <div className="h-panel-content">
          <div className="h-panel-top">
            <span className="h-num">02</span>
            <div className="h-icon"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg></div>
          </div>
          <div className="h-title-vertical">RPA & Desktop Flows</div>
          <div className="h-panel-bottom">
            <h3 className="h-title-horizontal">RPA & Desktop Flows</h3>
      ...
      <div className="h-panel p3" data-reveal>
        <div className="h-panel-bg"></div>
        <div className="h-panel-content">
          <div className="h-panel-top">
            <span className="h-num">03</span>
            <div className="h-icon"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4l16 16M4 20 20 4"/></svg></div>
          </div>
          <div className="h-title-vertical">API Integrations</div>
          <div className="h-panel-bottom">
            <h3 className="h-title-horizontal">API Integrations</h3>
      ...
      <div className="h-panel p4" data-reveal>
        <div className="h-panel-bg"></div>
        <div className="h-panel-content">
          <div className="h-panel-top">
            <span className="h-num">04</span>
            <div className="h-icon"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg></div>
          </div>
          <div className="h-title-vertical">Power Apps & PCF</div>
          <div className="h-panel-bottom">
            <h3 className="h-title-horizontal">Power Apps & PCF</h3>
      ...
      <div className="h-panel p5" data-reveal>
        <div className="h-panel-bg"></div>
        <div className="h-panel-content">
          <div className="h-panel-top">
            <span className="h-num">05</span>
            <div className="h-icon"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg></div>
          </div>
          <div className="h-title-vertical">Web Development</div>
          <div className="h-panel-bottom">
            <h3 className="h-title-horizontal">Web Development</h3>
      ...
      <div className="h-panel p6" data-reveal>
        <div className="h-panel-bg"></div>
        <div className="h-panel-content">
          <div className="h-panel-top">
            <span className="h-num">06</span>
            <div className="h-icon"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></div>
          </div>
          <div className="h-title-vertical">Ongoing Improvement</div>
          <div className="h-panel-bottom">
            <h3 className="h-title-horizontal">Ongoing Improvement</h3>
...
<section className="section">
  <div className="wrap">
    <div className="section-head" data-reveal>
      ...
      <h2>From Manual Work to a Better System</h2>
...
<section className="section section-alt hub-section">
  <div className="wrap">
    <div className="section-head text-center" data-reveal style={{marginBottom: "80px", display: "flex", flexDirection: "column", alignItems: "center"}}>
      ...
      <h2 style={{maxWidth: "800px", margin: "0 auto", fontSize: "42px", letterSpacing: "-1px"}}>Solutions for Teams That Want to Move Faster</h2>
